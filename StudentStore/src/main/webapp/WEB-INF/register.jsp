...
<body>
	...
	<div class="d-flex justify-content-center mt-sm-3">
	    <form:form action="/register" method="post" modelAttribute="newUser" class="p-3 w-25 mb-2 bg-info">
	        ...
	        <input type="submit" value="Register" class="btn btn-success ms-sm-3" />
	    </form:form>
	</div>
</body>
</html>