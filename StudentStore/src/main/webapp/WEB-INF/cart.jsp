...
<body>
	...
	<h2 class="d-flex justify-content-center">${currUser.userName}'s Cart: </h2>
		  	...
		  	<div class="card-body">
		    	...
		    	<div class="d-flex justify-content-start">
		    		<c:forEach items="${product.categories}" var="category">
		    			<a href="/${category.name}" class="btn btn-outline-primary mb-2"><c:out value="${category.name}"></c:out></a>
		    		</c:forEach>
		    	</div>
		    <div class="d-flex justify-content-start">
